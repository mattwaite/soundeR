...
Turn a data frame into a sonification. Print the result to hear it.
...
- [`luge_finals`](https://www.mattwaite.com/soundeR/reference/luge_finals.md)
  : Luge finals at the Milano Cortina 2026 Winter Olympics
- [`husker_games`](https://www.mattwaite.com/soundeR/reference/husker_games.md)
  : Nebraska men's basketball, 2025-26
- [`ne_house_years`](https://www.mattwaite.com/soundeR/reference/ne_house_years.md)
